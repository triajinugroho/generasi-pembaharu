<p align="center">
  ...
  <p align="center"><strong>Membangkitkan Generasi Muda Islam Indonesia sebagai Pembaharu Umat</strong></p>
</p>
...
**Generasi Pembaharu** adalah kumpulan buku, kurikulum, dan esai yang disusun sebagai referensi fundamental bagi gerakan dakwah pemuda Islam di Indonesia — khususnya para aktivis dakwah kampus.

Repo ini lahir dari satu keyakinan: **bahwa pemuda Muslim Indonesia hari ini membutuhkan lebih dari sekadar semangat. Mereka membutuhkan fondasi yang kokoh, wawasan yang luas, strategi yang tajam, dan hati yang hidup.**

Tiga krisis besar menghantam pemuda kita:
1. **Krisis Identitas** — Terombang-ambing antara arus modernitas dan akar keislaman
2. **Fragmentasi Gerakan** — Dakwah terpecah dalam sekat-sekat organisasi yang saling curiga
3. **Tantangan Digital** — Zaman berubah begitu cepat, dakwah tertinggal di belakang

Repo ini hadir untuk menjawab ketiganya. Secara holistik. Secara mendalam. Secara menggerakkan.

## Untuk Siapa?

- Aktivis Lembaga Dakwah Kampus (LDK)
- Pengurus dan anggota Rohis kampus/sekolah
- Mentor dan murabbi halaqah tarbiyah
- Siapa pun pemuda Muslim yang rindu menjadi pembaharu
...
| # | Bab | Deskripsi |
|---|-----|-----------|
| 0 | [Mukadimah](./00-mukadimah/) | Manifesto, peta krisis, dan visi kebangkitan |
| 1 | [Fondasi Aqidah](./01-fondasi-aqidah/) | Tauhid sebagai pembebasan dan penggerak perubahan |
| 2 | [Sirah & Sejarah](./02-sirah-dan-sejarah/) | Blueprint Nabawi hingga pergerakan Islam Indonesia |
| 3 | [Pembangunan Diri](./03-pembangunan-diri/) | Tarbiyah dzatiyah: dari muraqabah hingga kepemimpinan |
...
Repo ini bersifat **kurated community** — kontribusi terbuka namun melalui proses editorial review. Baca [CONTRIBUTING.md](./CONTRIBUTING.md) untuk panduan lengkap.

## Lisensi

Konten dalam repo ini dilisensikan di bawah [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/).

Anda bebas menggunakan, menyebarkan, dan mengadaptasi materi ini untuk kepentingan dakwah non-komersial, dengan tetap mencantumkan atribusi dan menggunakan lisensi yang sama.
