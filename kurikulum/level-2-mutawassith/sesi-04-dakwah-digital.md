...
1. Peserta mampu memahami lanskap media digital sebagai medan dakwah kontemporer.
2. Peserta mampu merancang strategi konten dakwah yang efektif dan menarik untuk platform digital.
3. Peserta mampu menerapkan etika Islam dalam aktivitas dakwah online.
4. Peserta mampu membuat rencana konten dakwah sederhana untuk satu platform pilihan.
...
### 2. Materi Inti A — Memahami Medan Dakwah Digital (20 menit)

- Lanskap digital Indonesia:
  - Platform utama: Instagram, TikTok, YouTube, X/Twitter, Telegram
  - Karakteristik audiens per platform
  - Tren konsumsi konten: short-form video, carousel, thread
- Peluang dakwah digital:
  - Jangkauan masif dengan biaya minimal
  - Kemampuan menyasar segmen spesifik
  - Konten yang bisa diakses kapan saja (asinkronus)
- Tantangan dakwah digital:
  - Algoritma yang memprioritaskan engagement, bukan kebenaran
  - Reduksi pesan kompleks menjadi simplifikasi berlebihan
...
- Framework pembuatan konten:
  ...
  - **Pilih format:** video pendek, carousel, infografis, tulisan panjang, podcast
  - **Buat hook yang kuat:** 3 detik pertama menentukan
  - **Sampaikan value:** setiap konten harus memberi manfaat
  - **Call to action:** arahkan audiens ke langkah berikutnya
- Jenis-jenis konten dakwah:
  - Konten ilmu: penjelasan ayat, hadits, fiqih praktis
  - Konten inspirasi: kisah sahabat, teladan ulama, motivasi
...
- Tips praktis per platform:
  ...
  - Twitter/X: thread berbobot, respons terhadap trending topic
  - Telegram: konten mendalam, seri kajian, komunitas eksklusif
...
- Prinsip etika dari Al-Qur'an dan Sunnah:
  ...
  - Tidak ghibah dan namimah, termasuk dalam bentuk digital
  - Menjaga aib orang lain, tidak mengekspos
- Etika spesifik dunia digital:
  - Tidak mencuri konten (hak cipta dan amanah intelektual)
  - Tidak memanipulasi fakta demi engagement
...
- Menjaga kesehatan mental digital:
  ...
  - Detox digital sebagai bagian dari mujahadah

### 5. Workshop Praktik (25 menit)

- Peserta dibagi menjadi tim kecil (3-4 orang)
- Setiap tim merancang:
  - Satu strategi konten dakwah untuk platform pilihan
  - Kalender konten 1 minggu (5-7 konten)
  - Satu contoh konten jadi (bisa berupa draft caption, storyboard video pendek, atau outline carousel)
- Presentasi singkat per tim (3-4 menit)
...
- Rekomendasi akun-akun dakwah yang bisa dijadikan referensi
- Doa penutup
...
1. Al-Qur'an: QS. An-Nahl: 125, QS. Al-Hujurat: 6, QS. An-Nisa: 9
2. Qardhawi, Yusuf. *Islam dan Seni* (Terj.). Jakarta: Pustaka Al-Kautsar. (Bab tentang media)
3. Mubarakfuri, Shafiyyurrahman. *Ar-Rahiq Al-Makhtum*. (Bab metode dakwah Nabi ﷺ)
